...
\begin{figure}[h]
  \centering{\includegraphics[width=10cm]{part2/fig6.pdf}}
  \caption{The training data for regularized linear regression.}\label{fig:6}
\end{figure}

\begin{figure}[h]
  \centering{\includegraphics[width=10cm]{part2/fig7.pdf}}
...
\begin{figure}[h]
  \centering{\includegraphics[width=10cm]{part2/fig8.pdf}}
  \caption{Learning curves.}\label{fig:8}
\end{figure}

\begin{figure}[h]
  \centering{\includegraphics[width=10cm]{part2/fig9.pdf}}
  \caption{Polynomial fit for lambda = 0 with a p=8 order model.}\label{fig:9}
\end{figure}

\begin{figure}[h]
  \centering{\includegraphics[width=10cm]{part2/fig10.pdf}}
...
\begin{figure}[h]
  \centering{\includegraphics[width=10cm]{part2/fig12.pdf}}
...
\begin{figure}[h]
  \centering{\includegraphics[width=10cm]{part2/fig11.pdf}}
